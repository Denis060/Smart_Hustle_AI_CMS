...
export default function PostDetail() {
  ...
  return (
    <section className="py-16 min-h-[70vh] flex flex-col items-center justify-center">
      <div className="max-w-3xl w-full bg-slate-800 rounded-2xl shadow p-8 flex flex-col gap-4 border border-slate-700">
        ...
        <div className="text-slate-300 text-lg mb-4" dangerouslySetInnerHTML={{ __html: post.content }} />
        <div className="flex gap-4 mt-4 items-center">
          ...
          <button onClick={() => document.getElementById('comments').scrollIntoView({ behavior: 'smooth' })} className="px-4 py-2 rounded bg-slate-700 text-white font-bold hover:bg-slate-600 transition">Comment</button>
